...
const FORMA_OPTIONS = ['Ditta individuale', 'SRL', 'SNC', 'SAS', 'SPA', 'Libero professionista']
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-slate-50 rounded-2xl border border-slate-200 p-5">
        ...
        <p className="text-xs text-slate-400 mt-4">
          Per modificare ragione sociale, P.IVA o email contatta il supporto.
        </p>
      </div>
      ...
      {/* ── CATEGORIE ── */}
      <div>
        <h3 className="text-sm font-semibold text-slate-700 uppercase tracking-wider mb-1.5">Categorie di servizio</h3>
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={saving}
          className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white font-semibold px-8 py-3 rounded-xl transition-colors"
        >
